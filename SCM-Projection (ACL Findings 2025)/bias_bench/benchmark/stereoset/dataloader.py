...
"""
IntrasentenceExample(ID, bias_type, target, context, sentences) <- Example

Example(ID, bias_type, target, context, sentences)
...
) <- StereoSet(input_file)

StereoSet(location, json_obj=None)
"""
