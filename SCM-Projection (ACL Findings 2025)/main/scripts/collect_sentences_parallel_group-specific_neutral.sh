...
OUTPUT_DIR=../sentences_collection_parallel_group-specific_neutral/$model_name_or_path/$bias
...
python -u ../collect_sentences_parallel_group-specific_neutral.py \
    --input ../../data/$data \
    ...
    --ab_test_type 'final' > ../../log/collect-sentence/collect-group-specific_neutral-$bias.log
