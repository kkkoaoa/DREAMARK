...
CUDA_VISIBLE_DEVICES=$gpu python main.py --text "$prompt" --iters 30000 --scale 7.5 --dmtet --mesh_idx 0  --init_ckpt $recent_ckpt/best_df_ep0150.pth --density_thresh 0.1 --finetune True --workspace exp-dmtet-stage3/ --eval_mark

CUDA_VISIBLE_DEVICES=$gpu python main.py --text "$prompt" --iters 30000 --scale 7.5 --dmtet --mesh_idx 0  --init_ckpt $recent_ckpt/best_df_ep0150.pth --density_thresh 0.1 --finetune True --workspace exp-dmtet-stage3/ --eval_mark --msg_length 16
