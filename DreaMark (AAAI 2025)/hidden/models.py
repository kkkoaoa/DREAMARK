...
import hidden.attenuations as attenuations
...
class HiddenEncoder(nn.Module):
    ...
    """
    def __init__(self, num_blocks, num_bits, channels, last_tanh=False, **kwargs):
...
class HiddenDecoder(nn.Module):
    ...
    """
    def __init__(self, num_blocks, num_bits, channels, **kwargs):
