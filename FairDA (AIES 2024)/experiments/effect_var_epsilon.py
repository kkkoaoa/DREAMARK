...
if __name__ == "__main__":
    ...
    for kk in range(0, 3):
        ...
        np.save(
            "record/epsilon_unbias_test_accuracy_before" + str(kk) + ".npy",
            np.array(test_accuracy_before),
        )
        np.save(
            "record/epsilon_unbias_test_dp_before" + str(kk) + ".npy",
            np.array(test_dp_before),
        )
        np.save(
            "record/epsilon_unbias_test_accuracy_after" + str(kk) + ".npy",
