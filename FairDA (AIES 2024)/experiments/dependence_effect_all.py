    ...
    for kk in range(0, 1):
        ...
        for cover in coverges:
            ...
            (
                ...
                D_init_num=1, D_providers_num=5, add_noise_bool=True, coverage=cover
            )
            ...
            budget = 0.5 * D_provider_x[0].shape[0]
            ...
            if True:
                ...
                for rr in range(repeat_times):
                    D_obtained = []
                    for ii in range(providers_num):
                        amount = int(budget / 3 / providers_num / price[ii])
            ...
            if False:
                ...
                np.save(
                    "record/budget_unbias_test_accuracy_after_off_eo_nf"
                    + str(kk)
                    + ".npy",
                    np.array(test_accuracy_after),
                )
            ...
            if False:
                ...
                np.save(
                    "record/budget_unbias_test_accuracy_after_off_dp"
                    + str(kk)
                    + ".npy",
                    np.array(test_accuracy_after),
                )
            ...
            if False:
                ...
                np.save(
                    "record/budget_unbias_test_accuracy_after_off_eo"
                    + str(kk)
                    + ".npy",
                    np.array(test_accuracy_after),
                )
